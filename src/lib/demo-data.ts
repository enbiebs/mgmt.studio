  ...
  clients: [
    {
      ...
      songs: {
        albums: [{
          ...
          title: 'Mascolo 2026',
          tracks: [
            { id: 't1',  num: 1,  title: 'Long Time',              stage: 'mix',    version: 10, touched: '10d', labelCopy: { isrc: 'USRC12600001', writers: 'D. Mascolo, R. Cole', producers: 'D. Mascolo', pro: 'BMI', duration: '3:24', language: 'English' } },
            { id: 't2',  num: 2,  title: 'CTMH',                   stage: 'mix',    version: 8,  touched: '12d', labelCopy: { isrc: 'USRC12600002', writers: 'D. Mascolo', producers: 'D. Mascolo', pro: 'BMI', duration: '2:58', explicit: true } },
            { id: 't3',  num: 3,  title: 'Nobody Else',            stage: 'mix',    version: 6,  touched: '12d' },
            { id: 't4',  num: 4,  title: 'All Of My Love',         stage: 'mix',    version: 5,  touched: '12d' },
            { id: 't5',  num: 5,  title: 'Fade Away',              stage: 'mix',    version: 7,  touched: '12d' },
            { id: 't6',  num: 6,  title: 'Never Changes',          stage: 'mix',    version: 4,  touched: '12d' },
            { id: 't7',  num: 7,  title: "When You're Not Around", stage: 'mix',    version: 3,  touched: '12d' },
            { id: 't8',  num: 8,  title: 'Close To You',           stage: 'mix',    version: 5,  touched: '12d' },
            { id: 't9',  num: 9,  title: 'Outro',                  stage: 'mix',    version: 2,  touched: '12d' },
            { id: 't10', num: 10, title: 'The Ropes',              stage: 'track',  version: 1,  touched: '12d' },
          ],
